...
import { getCurrentUser, updateUserProfile, logoutUser } from '../utils/storage';
import { User, Image as ImageIcon, Save, LogOut, Info, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="page-container container animate-fade-in">
      <div className="admin-header">
        <h2 className="section-title">Profil <span className="neon-text">Ayarları</span></h2>
        <button className="btn-secondary" onClick={handleLogout} style={{ color: '#ff4444', borderColor: 'rgba(255,68,68,0.3)' }}>
          <LogOut size={18} /> Çıkış Yap
        </button>
      </div>

      <div className="glass-card" style={{ maxWidth: '600px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
